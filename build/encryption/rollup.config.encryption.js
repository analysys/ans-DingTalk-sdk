    ...
    output: [
        {
            ...
            file: './DingTalkDemo/util/sdk/AnalysysAgent_encryption.min.js',
            format: 'cjs',
            name: 'Ans',
            plugins: [
                uglify({
            ...
            file: './DingTalkDemo/util/sdk/AnalysysAgent_encryption.es6.min.js',
            format: 'esm',
            name: 'Ans',
            plugins: [
                terser({
        ...
        {
            file: './taroDemo/util/sdk/AnalysysAgent_encryption.es6.min.js',
            format: 'esm',
            name: 'Ans',
            plugins: [
                terser({
