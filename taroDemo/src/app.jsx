...
// 钉钉和支付宝一样的，TARO_ENV 都是 alipay ，在DingTalk的demo我们这里改成dingtalk Demo
if (process.env.TARO_ENV === 'alipay') {
    AnalysysAgent = require('./sdk/AnalysysAgent_Dingtalk_SDK.min.js')
}
if (process.env.TARO_ENV === 'weapp') {
    AnalysysAgent = require('./sdk/AnalysysAgent_WX_SDK.custom.min.js')
}
if (process.env.TARO_ENV === 'swan') {
    AnalysysAgent = require('./sdk/AnalysysAgent_Baidu_SDK.min.js')
}
